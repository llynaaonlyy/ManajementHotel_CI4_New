...
$routes->get('admin/booking/delete/(:num)', 'Admin::bookingDelete/$1');
    
// Users
$routes->get('admin/users', 'Admin::users');
$routes->post('admin/users/update', 'Admin::userUpdate');
$routes->post('admin/users/tambah', 'Admin::userTambah');
$routes->get('admin/users/delete/(:num)', 'Admin::userDelete/$1');
