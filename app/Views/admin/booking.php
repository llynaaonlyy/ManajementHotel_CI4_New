    ...
    <div class="top-bar">
        ...
        <div class="dashboard-wrapper">
            ...
            <aside class="sidebar">
                ...
                <a href="<?= base_url('admin/booking') ?>" class="active"><i class="fas fa-calendar-check me-2"></i>Data Booking</a>
                <a href="<?= base_url('admin/users') ?>"><i class="fas fa-users me-2"></i>Manajemen User</a>
